        ...
        <AnimatedSection id="pricing" className="py-20 px-6 relative z-10">
            <div className="mx-auto max-w-4xl text-center">
                ...
                >
                    ...
                    <div className="text-[#013F40] text-lg font-medium mb-2">{t("pricing.subtitle")}</div>
                    <div className="flex items-baseline justify-center gap-1 text-[#013F40]">
                        <span className="text-5xl font-bold">{t("pricing.price")}</span>
                        <span className="text-lg opacity-60">{t("pricing.period")}</span>
                    </div>
                    ...
                    <div className="space-y-4 text-left mb-10">
                        {featuresData.map((featureKey) => (
                            <div key={featureKey} className="flex items-center gap-3">
                                ...
                                <span className="text-[#013F40]/80 font-medium">{t(featureKey)}</span>
                            </div>
                        ))}
                    </div>
